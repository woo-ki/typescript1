...
var anchor = document.querySelector('#link');
...
var introduce = function (e, x) {
    console.log(e);
    console.log(x);
    console.log(e.target);
};
var btn = document.querySelector('#button');
btn === null || btn === void 0 ? void 0 : btn.addEventListener('click', function bindTest(e) {
    introduce(e, '안뇽~');
    btn === null || btn === void 0 ? void 0 : btn.removeEventListener('click', bindTest);
});
...
var anchorList = document.querySelectorAll('.naver');
